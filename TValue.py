...
class TValue(): 
    ...
    def copy(self):
        return self.exceptionError(f"The 'copy()' method not supported on the {Error.classNameOf(self)} class!")
...
class TList(TValue):
    ...
    def index(self, other):
        ...
        if isinstance(other, TNumber):
            ...
            for element in inlistValues:
                newList.append(element * other.value)
